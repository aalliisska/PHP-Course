...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Model/UserRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Infrastructure/UserRepository.php';

        $container->services['App\\Controller\\UserController'] = $instance = new \App\Controller\UserController(new \App\Infrastructure\UserRepository());
